...
function crTbSingles (){
  ...
  ["lastname"=>"Paceo", "firstname"=>"Anne", "age"=>"37", "gender"=>"cookie", "mail"=>"anpaceo@yahoo.fr", "zipcode"=>"71150", "picture"=>"PaceoA4.jpg", "description"=>"Je suis une furieuse, j'aime taper, mais sous la carapace, un tendre coeur bat !"],
